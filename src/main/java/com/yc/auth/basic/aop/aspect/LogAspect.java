package com.yc.auth.basic.aop.aspect;

import cn.hutool.core.util.StrUtil;
import com.alibaba.fastjson.JSON;
import com.yc.auth.basic.annotation.Log;
import com.yc.auth.basic.enums.OperateStatus;
import com.yc.auth.basic.util.IpUtils;
...
public class LogAspect {
     ...
     * 织入点
     */
    @Pointcut("@annotation(com.yc.auth.basic.annotation.Log)")
